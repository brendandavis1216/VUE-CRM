...
import { Event, EventStatus } from "@/types/app"; // Import Event and EventStatus types
...
const EventDayContent: React.FC<DayContentProps> = (props) => {
  ...
  return (
    <div className="relative h-full w-full flex items-center justify-center">
      <span className="text-white">{children}</span> {/* Explicitly apply text-white to the day number */}
        ...
        <CardContent className="p-0">
          <DayPicker
            ...
            classNames={{
              ...
              head_row: "flex",
              head_cell: "rounded-md w-9 font-normal text-[0.8rem] text-white", // Changed to text-white
              ...
              day: cn(
                "h-9 w-9 p-0 font-normal aria-selected:opacity-100 rounded-md", // Removed text-white from here
